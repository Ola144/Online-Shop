...
const Signup = () => {
  // const [userSignup, setUserSignup] = useState<UserModel>(new UserModel());
  ...
  const signupUser = async (data: any) => {
    // console.log(data.emailId, data.fullName, data.password, data.role);
    setLoader(true);
    try {
