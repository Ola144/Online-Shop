...
const About = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-tl from-pink-50 to-pink-100 py-10 px-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 my-10 md:gap-3 gap-10 items-center justify-center w-full">
        <div className="flex justify-start">
          <p className="me-3 text-5xl text-gray-500">
            <i className="fa fa-phone-square"></i>
          </p>
          <div>
            <p className="text-black text-lg font-bold">Call Us:</p>
        ...
        <div className="flex lg:justify-center justify-start">
          ...
          <div>
            <p className="text-black text-lg font-bold">Or Send E-mail:</p>
            <p className="text-pink-500 text-xl font-bold">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 my-10 md:gap-3 gap-10 items-center justify-center w-full">
        <div className="col-span-1 lg:col-span-2 bg-green-600 py-10 px-2 lg:w-full w-fit mx-auto">
          <div className="flex lg:justify-between justify-center gap-4 lg:w-full w-fit">
            <div>
              <p className="text-black font-bold lg:text-lg text-sm mb-3">
            ...
            <button
              className="bg-red-500 text-white text-xs h-12 px-2 w-24 rounded-lg font-bold hover:bg-red-400"
        ...
        <div className="col-span-1 border-2 border-red-500 lg:p-8 p-7 text-center w-fit md:w-full mx-auto">
          ...
          <p className="lg:text-5xl md:text-5xl text-6xl text-red-500 font-bold">
